...
public class Test {
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println("SELECT name, genre from dbo.SongsTable");
        ...
        System.out.println();
        System.out.println("SELECT name, CountryPopulation FROM dbo.CountriesTable WHERE CountryPopulation<? AND CountryName LIKE ?");
